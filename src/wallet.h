...
public:
    ...
    int ScanForWalletTransactions(CBlockIndex* pindexStart, bool fUpdate = false, bool fImport = false);
    ...
    bool CreateTransaction(const std::vector<std::pair<CScript, int64_t> >& vecSend,  CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet, std::string& strFailReason, std::string strTxComment, const CCoinControl *coinControl=NULL);
    bool CreateTransaction(CScript scriptPubKey, int64_t nValue, CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet, std::string& strFailReason, std::string strTxComment, const CCoinControl *coinControl=NULL);
