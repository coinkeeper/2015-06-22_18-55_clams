...
bool CWallet::CreateTransaction(const vector<pair<CScript, int64_t> >& vecSend CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet, std::string& strFailReason, std::string strTxComment, const CCoinControl* coinControl)
{
    int64_t nValue = 0;
...
bool CWallet::CreateTransaction(CScript scriptPubKey, int64_t nValue,  CWalletTx& wtxNew, CReserveKey& reservekey, int64& nFeeRet, std::string& strFailReason, std::string strTxComment, const CCoinControl* coinControl)
{
