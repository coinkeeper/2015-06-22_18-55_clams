...
//	    {"54.186.202.251", "54.186.202.251"},
  //    {"54.186.249.57", "54.186.249.57"},
//	    {"54.186.94.88", "54.186.94.88"},
 //       {"54.187.138.13", "54.187.138.13"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("clam-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Clam is probably already running."), addrBind.ToString().c_str());
        else
